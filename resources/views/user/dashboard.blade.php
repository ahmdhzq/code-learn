            ...
            <div class="col">
                <div class="card h-100 shadow-sm border-0">
                    <div class="card-body p-4">
                        ...
                        {{-- Di sini nanti bisa ditambahkan progress bar per track --}}
                    </div>
                    <div class="card-footer bg-white border-0 p-4 pt-0">
                        <a href="{{ route('learn.track.show', $track) }}" class="btn btn-outline-primary w-100 fw-semibold">Lanjutkan Belajar</a>
                    </div>
                </div>
            </div>
        @empty
