...
@section('page-title', 'Tambah Learning Track')
    ...
    <div class="row justify-content-center">
        <div class="col-lg-8 col-xl-6">
            ...
            <div class="d-flex align-items-center mb-4">
                ...
                <div>
                    <h4 class="mb-0 fw-bold text-dark">Tambah Track Baru</h4>
                    <p class="text-muted mb-0 small">Buat learning track untuk mengorganisir pembelajaran</p>
                </div>
            </div>
                    ...
                    <form action="{{ route('admin.tracks.store') }}" method="POST" class="needs-validation" novalidate>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      name="description" 
                                      rows="4" 
                                      placeholder="Jelaskan tujuan dan materi yang akan dipelajari dalam track ini...">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">
                                    <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
                                </div>
                        ...
                        <div class="d-flex gap-2 justify-content-end pt-3 border-top">
                            ...
                            <button type="submit" class="btn btn-primary px-4">
                                <i class="fas fa-save me-2"></i>Simpan Track
                            </button>
                        </div>
                    </form>
                </div>
